...
export const mySocials = [
  {
    name: "GitHub",
    href: "https://github.com/teddymitei",
    icon: "/assets/socials/github.svg",
  },
  {
    name: "Linkedin",
    href: "https://www.linkedin.com/in/teddy-mitei-042256307/",
    icon: "/assets/socials/linkedIn.svg",
  },
  {
    name: "Instagram",
    href: "https://www.instagram.com/teddymitei/",
...
export const experiences = [
  {
    ...
    contents: [
      ...
      "User support ",
      "Fiber splicing",
      "Patch cable maintenance ",
      "ICT LAN support ",
      "Troubleshooting ",
      "Ping testing ",
      "Workflow and work ethics" ,
      "Customer service",
      "Hardware preventive and breakdown maintenance ",
      "Software preventive and breakdown maintenance ",
